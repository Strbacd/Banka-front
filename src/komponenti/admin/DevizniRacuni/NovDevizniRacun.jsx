...
class NovDevizniRacun extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            korisnikId: '',
    ...
    dodajDevizniRacun() {
        ...
        fetch(`${serviceConfig.baseURL}/api/KontrolerDeviznihRacuna`, parametriZahteva)
            .then(odgovor => {
                if (!odgovor.ok) {
            ...
            .then(odgovor => {
                NotificationManager.success('Devizni racun je uspesno napravljen!');
                this.props.history.push('SviDevizniRacuni');
            })
            .catch(odgovor => {
...
export default withRouter(NovDevizniRacun);